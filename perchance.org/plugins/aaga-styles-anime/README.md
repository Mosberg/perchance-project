...
## Files
- `aaga-styles-anime.html`
- `aaga-styles-anime.perchance`

## What It Does
- Provides plugin-level functionality inside `C:\Users\Rasmu\Documents\perchance.org-project-mosberg\mosberg-perchance.org\plugins\aaga-styles-anime`.
...
## Usage
Import with `{import:aaga-styles-anime}` and evaluate it where needed in your generator/framework.

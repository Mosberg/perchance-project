...
## Files
- `copy-text-plugin.html`
- `copy-text-plugin.perchance`

## What It Does
- Provides plugin-level functionality inside `C:\Users\Rasmu\Documents\perchance.org-project-mosberg\mosberg-perchance.org\plugins\copy-text-plugin`.
...
## Usage
Import with `{import:copy-text-plugin}` and evaluate it where needed in your generator/framework.
